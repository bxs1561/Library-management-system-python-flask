...
/**
 * Display book checkout in table.
 */
...
// },[dispatch])
  ...
  /**
   * Filter the 'user' array to find users with matching user_id
   */
            ...
            <div className="reservationSearch___box">
                ...
                {userData?.length === 0 ? (
                  <UserSearch user_id={''} first_name={''}
                              last_name={''} phone_number={''} email={''} status_value={''} 
                              user_image_url={'https://via.placeholder.com/400X400'} />
                  ) : (
                      userData?.map(result => (
...
/**
 * Search and show user information to be added into checkout.
 */
...
/**
 * Search and show book information to be added into checkout.
 */
